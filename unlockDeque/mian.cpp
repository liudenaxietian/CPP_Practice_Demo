// 链接：https : // zhuanlan.zhihu.com/p/547055774
...
public:
  //-构造函数
  storage_model() : begin_node((storage_node *)calloc(1, sizeof(storage_node))), //-初始就有一个node
                    begin_index(0),
